...
INSERT INTO public.t_panier (id, prix_total) VALUES (1, null);
SELECT setval('t_panier_id_seq', 2, true);
...
INSERT INTO public.t_user (id, active, anniversaire, email, genre, newsletter, nom, password, prenom, panier_id) VALUES (3, null, '1988-07-02', 'test@gmail.com', 'Monsieur', false, 'Paul', '$2a$10$9kXDz3wiloAzoxUaylJKXOj0RHFuJGyOTb4UvdCpNxptZcdsogfIi', 'Pierre', 1);
...
INSERT INTO public.t_produit (id, allergenes, commentaire_producteur, commentaire_produit, composition, conseil_utilisation, description_produit, info_nutrition, name, origine, pourquoi, producteur, url_grande_photo, url_petite_photo, categorie_id, reduction_id, sous_categorie_id, type_id) VALUES (1, 'aaaaaaaa', 'aaaaaaaaaaaaaaaaaaaaaaaaaa', 'aaaaaaaaaaaa', 'aaaaaaaaaaaaaaaaaaa', 'aaaaaaaaaaaaaaaaaa', 'aaaaaaaaaaaa', 'aaaaaaaaaaaaaaaaaaaaa', 'Thé Noir test', 'france', 'aaaaaaaaaaaaaaaaaaaa', 'aaaaaaaaaaaaaaaaa', '', '', 2, null, 2, 2);
select setval('t_produit_id_seq', 2,true);

INSERT INTO public.t_variant (id, name, prix, prix_kg, prix_reduction, stock, produit_id) VALUES (1, '250g', 2.5, 10, null, 'STOCK_FAIBLE', 1);
select setval('t_variant_id_seq', 2,true);
